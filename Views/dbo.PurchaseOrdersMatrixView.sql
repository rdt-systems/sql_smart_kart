...
CREATE VIEW [dbo].[PurchaseOrdersMatrixView]
AS
SELECT        PurchaseOrders.PurchaseOrderId, PurchaseOrders.SupplierNo, PurchaseOrders.StoreNo, PurchaseOrders.PoNo, PurchaseOrders.PersonOrderdId, PurchaseOrders.GrandTotal, PurchaseOrders.ShipVia, 
                         ...
                         PurchaseOrders.TermsID, PurchaseOrders.BuyerID, PurchaseOrders.BillToStoreID, PurchaseOrders.VendorPONo, PurchaseOrders.DepartmentID, PurchaseOrders.SeasonID
