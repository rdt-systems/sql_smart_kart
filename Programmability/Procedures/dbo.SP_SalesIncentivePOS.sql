...
GO
CREATE PROCEDURE [dbo].[SP_SalesIncentivePOS]
(
...
FROM            dbo.SalesIncentive INNER JOIN
                         ...
                         NewDate.ToDate = SalesIncentiveHeader_1.ToDate  WHERE (dbo.SalesIncentive.DateModified >@DateModified) AND ISNULL(dbo.SalesIncentive.Status, 1)>0
GO