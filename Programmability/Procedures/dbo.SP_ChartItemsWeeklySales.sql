...
CREATE PROCEDURE [dbo].[SP_ChartItemsWeeklySales]
...
set @MySelect= '''and OptionID=''131'')
				Select  sum(Qty) as Qty,
						...
						Convert(nvarchar,dbo.GetFirstDayOfWeek(StartSaleTime,@FirstDayOfWeek),101) as WeekNumber
				From dbo.' + @TableName + ' INNER JOIN #ItemSelect ON '+ @TableName+ '.ItemStoreID = #ItemSelect.ItemStoreID ' 

Declare @MyGroupBy nvarchar(4000)
set @MyGroupBy=' Group By dbo.GetFirstDayOfWeek(StartSaleTime,@FirstDayOfWeek)
