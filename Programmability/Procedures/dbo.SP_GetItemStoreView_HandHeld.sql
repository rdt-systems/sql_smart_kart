...
GO
CREATE PROCEDURE [dbo].[SP_GetItemStoreView_HandHeld]
...
IF @ID IS NOT NULL 
		BEGIN 
			  SELECT     dbo.ItemStoreView.ItemStoreID, dbo.ItemStoreView.ItemNo, dbo.ItemStoreView.StoreNo,dbo.ItemStoreView.Cost,dbo.ItemStoreView.Price
